...
% DL_lists = ["RRNet"]; % used for load mat
% Alg_names = {'BT_H', 'PanNet', 'FusionNet'};
% Alg_names = ["BDSD_PC", "MTF_GLP_FS", "MTF_GLP_HPM", "CVPR19", "BT_H", "PNN", "DiCNN", "PanNet", "FusionNet", "LAGConv", "DCFNet"]; 
DL_lists = ["fdmamba"]
Alg_names = DL_lists;
opts.copy_list = [];
...
opts.sensor = 'GF2'; % 'WV3', 'WV2', 'QB', 'GF2', you don't set 'none' (modified sensor cases of MTF_PAN, genMTF, build_TV).
opts.task = 'pansharpening';
opts.file = 'test_gf2_OrigScale_multiExm1';
%%
...
for num = 1:exm_num
    ...
    % I  = double(sr);
    % showImage4LR(I,printEPS,1,flag_cut_bounds,dim_cut,thvalues,L, opts.ratio);
